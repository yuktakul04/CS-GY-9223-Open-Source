...
map_tf_var "chat_client_provider" "CHAT_CLIENT_PROVIDER"
...
map_tf_var "slack_bot_token" "SLACK_BOT_TOKEN"
map_tf_var "chat_client_allowed_channel_ids" "CHAT_CLIENT_ALLOWED_CHANNEL_IDS"
